...
export async function createSubscriptionPlan(
  ...
  const parsed = subscriptionPlanSchema.safeParse({
    ...
    benefits_gym_freeze: formData.get('benefits_gym_freeze') === 'on',
    benefits_gym_export: formData.get('benefits_gym_export') === 'on',
    benefits_gym_stats: formData.get('benefits_gym_stats') === 'on',
