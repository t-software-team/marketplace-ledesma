-- ============================================================
-- 20260728000009_feed_search_shop_name.sql
-- get_products_feed solo buscaba por nombre/tsvector del
-- producto. Ahora también matchea el nombre del comercio, así
-- buscar "Panadería López" muestra sus productos aunque el
-- texto no aparezca en el nombre de cada producto.
-- ============================================================
drop function if exists public.get_products_feed(double precision, double precision, uuid, text, integer, integer, text);
