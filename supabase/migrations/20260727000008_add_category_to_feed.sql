-- ============================================================
-- 20260727000008_add_category_to_feed.sql
-- Suma nombre de categoría/subcategoría al retorno de
-- get_products_feed para poder mostrar un breadcrumb en la card
-- del feed público sin queries N+1 en el frontend.
-- ============================================================
